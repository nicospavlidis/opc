...
%
%Every time MATLAB or Octave is restarted you need to include the OPC
...
%%
%Then the execute the {\tt setpath} script which adds to the MATLAB/ Octave search
...
%
%Using {\tt help} from the MATLAB or Octave terminal
