...
\definecolor{mymauve}{HTML}{B452F1}
\lstset{
	language=Octave,
...
% Code that renders ' appear correctly in verbatim environment
\makeatletter
...
\end{htmlonly}
%
\caption{Cluster hierarchy after splitting node 2 and its children, and then
after pruning node 3. Note how the numbers of nodes have changed after pruning
the tree: node numbers represent the order in which nodes are added to the
tree}
%
\label{fig:val2} \end{figure} \noindent
%
