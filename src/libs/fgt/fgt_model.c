/*
 ...
 mex  -f mexopts_intel10.bat -output fgt_model.dll fgt_model.c
...
void fgt_model(double * , double * , double  , int  , int , double , double * , double * , int  , int , int * , int * , int * , int * , double * , double * , int * , int * , double * , double * , int );
...
void fgt_model(double *x , double *w , double sigma , int p , int K , double e , double *xc , double *A_k , int d , int Nx , int *indxc , int *indx , int *xhead , int *xboxsz , double *dist_C , double *C_k , int *heads , int *cinds , double *dx , double *prods , int pd)
{		
